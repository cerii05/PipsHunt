...
public class NPCChase : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (bustedScreen != null) bustedScreen.SetActive(false);
    }
    ...
    {
        // 1. Show the UI
        if (bustedScreen != null) bustedScreen.SetActive(true);
        ...
        // 3. Stop this NPC (Disable the script)
        enabled = false; 
    }
